            ...
            <div className='AccountModulePage'>
                <Container fluid>
                    <Row>
                        ...
                        <Col md={9}>
                            <Headings MainHeading={"Account Module"} SubHeading={"Manage your Manage Accounts"} HeadButton={<SharedButton BtnLabel={"Create Account"} BtnVariant={'primary'} style={{ background: '#00285D' }} />} />
                            <Tabs
